    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md bg-card rounded-2xl shadow-sm border border-border p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-border rounded-xl text-sm font-medium text-foreground bg-card hover:bg-background transition-colors disabled:opacity-60 disabled:cursor-not-allowed mb-5"
        >
          <GoogleIcon />
