export default function AdaptiveIllustration() {
  return (
    <svg viewBox="0 0 400 360" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="w-full h-full">
      {/* Background blob */}
      <ellipse cx="200" cy="200" rx="170" ry="140" fill="#d7ffb8" />

      {/* Screen / device */}
      <rect x="80" y="100" width="240" height="160" rx="16" fill="white" stroke="#e5e5e5" strokeWidth="2" />
      <rect x="80" y="100" width="240" height="36" rx="16" fill="#58cc02" />
      <rect x="80" y="120" width="240" height="16" fill="#58cc02" />
      ...
      {/* Chart bars */}
      <rect x="110" y="200" width="28" height="40" rx="6" fill="#e5e5e5" />
      <rect x="150" y="180" width="28" height="60" rx="6" fill="#1cb0f6" />
      <rect x="190" y="160" width="28" height="80" rx="6" fill="#58cc02" />
      <rect x="230" y="145" width="28" height="95" rx="6" fill="#58cc02" />
      ...
      {/* Brain icon blob */}
      <circle cx="310" cy="90" r="40" fill="#a570ff" />
      ...
      <path d="M308 88 Q314 82 320 88 Q326 82 332 88" stroke="#a570ff" strokeWidth="2" fill="none" strokeLinecap="round" />
      <path d="M308 96 Q314 102 320 96 Q326 102 332 96" stroke="#a570ff" strokeWidth="2" fill="none" strokeLinecap="round" />

      {/* Sparkles */}
      <path d="M60 80 L64 70 L68 80 L78 84 L68 88 L64 98 L60 88 L50 84 Z" fill="#ffc700" />
      <path d="M350 200 L353 192 L356 200 L364 203 L356 206 L353 214 L350 206 L342 203 Z" fill="#cc348d" />
